...
class ChatFragment : Fragment() {
    ...
    private fun loadChats() : ArrayList<Chat> {
        ...
        chats.add(Chat(R.drawable.robot, "Chuks", getString(R.string.msg4), "9:28pm"))
        chats.add(Chat(R.drawable.laptop, "mr maybe", getString(R.string.msg2), "9:28pm"))
        chats.add(Chat(R.drawable.brooch, "Lola", getString(R.string.msg6), "9:24pm"))
        ...
        chats.add(Chat(R.drawable.cookie, "Deborah", getString(R.string.msg1), "9:15pm"))
        chats.add(Chat(R.drawable.wiki, "Dad", getString(R.string.msg13), "9:10pm"))

        chats.add(Chat(R.drawable.fox_s, "Ryder", getString(R.string.msg3), "9:09pm"))
        chats.add(Chat(R.drawable.yellow, "Tom", getString(R.string.msg5), "9:00pm"))
